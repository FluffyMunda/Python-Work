...
connection = mysql.connector.connect(host = "localhost" , username = "root" , password = "123456789" , database = "event")
...
# to update the event
    ...
    updatevent = "update eventdata set eventname = 'Meritorious Certification Distribution' , eventdate = '22/12/2024' , venue = 'AUDI 2' where eventid = '1'"
...
# to update the student data
    ...
    updatestudata  = "update studentdata set studemail = 'uday@gmail.com' where studentid = '1'"
